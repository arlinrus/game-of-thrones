...
#### **Детальная визуализация для 1 книги**
...
#### **Детальная визуализация для 5 книги**
...
Во-первых, мир «Игры престолов» сильно фрагментирован. Уже в первой книге герои разбиты на группы, который хорошо совпадаю с основным сюжетом: Север и дом Старков, королевский двор и Ланнистеры, восточная линия Дейенерис. Алгоритмы кластеризации (Louvain) автоматически выделяют эти группы, что показывает: общая структура истории четко видна во взаимодействии героев.

Во-вторых, мы увидели, как меняется состав центральных узлов при переходе от книги к книге. Сначала это Эддард Старк и Роберт Баратеон, вокруг которых крутится основной сюжет. Постепенно их место занимают Тирион Ланнистер, Джон Сноу, Дейенерис Таргариен и Станнис Баратеон. Это не просто повороты сюжета (кто умер, кто пришел к власти), а перестройка всей системы власти: старые шишки уходят, появляются новые.

В-третьих, сетевые метрики показывают, что важный персонаж не всегда напрямую связана с количеством его появлений.Некоторые герои вроде и не так часто встречаются, но оказываются важными связующими звеньями. Они как мостики между разными группами. Такие узлы, обладающие высокой betweenness centrality, можно рассматривать как точки потенциального «разрыва» сети, если их убрать, мир Игры престолов распадется на части.
...
Что это дает? Такой анализ можно использовать не только для книг. Похожим образом можно копаться в устройстве компаний или социальных движений. Игра престолов – понятный пример, на котором удобно учиться анализировать сети, понимать разные показатели и вообще работать с данными. Потом эти знания можно применять к реальным социальным сетям, общению на работе или даже к политике.

### Ограничения данных и идеи продолжения проекта».

Как можно продолжить наше исследование? Например, можно учитывать, как герои относятся друг к другу (дружба, вражда), или построить сеть по каждой главе, посмотреть, как все меняется. Еще можно сравнить структуру книг и сериала от HBO. Так мы лучше поймем, как решения авторов и сценаристов влияют на мир и как зрители воспринимают героев.
